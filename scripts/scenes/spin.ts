module scenes {
    export class Spin extends objects.Scene {
        private _playPic: objects.Background;
        private _slot : objects.Background;
        private _money: objects.Label;
        private _Bet: objects.Label;
        private _jackPot: objects.Label;
        private _buttonReset: objects.Button;
        private _buttonSpin: objects.Button;
        private _buttonQuit: objects.Button;
        private _customerMney: number;
        private _moneyBet: number;
        ...
        private _rollXLoc: number[];
        private _rolls: objects.Roll[];
        ...
        public Start(): void {
            ...
            this._rolls = new Array<objects.Roll>();
            // instantiates the x coordinates for the reels
            this._rollXLoc = new Array<number>();
